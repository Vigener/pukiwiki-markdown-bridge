...
- PukiWikiの仕様に合わせて自動丸め（ダウングレード）される箇所を事前確認できる **Markdown丸め確認機能**
...
- **深い箇条書きの制限保護:** PukiWikiは深さ3までの箇条書きしかサポートしていません。Markdown側で深さ4以上（例: `    - 4`）を入力してPukiwikiへ反映しようとした場合、データ消失を防ぐために自動的に深さ3へと丸められます。この際、確認のモーダルが表示されます。
